...
const TopCardBlock = () => {
  ...
  useEffect(() => {
    ...
    const fetchTotalJobs = async () => {
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_SERVER_HOST}/fetchJobStatistics`);
    ...
    const fetchTotalRejected = async () => {
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_SERVER_HOST}/fetchTotalRejectedJobs`);
    ...
    const fetchTotalAccepted = async () => {
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_SERVER_HOST}/getTotalShortlistedApplicants`);
